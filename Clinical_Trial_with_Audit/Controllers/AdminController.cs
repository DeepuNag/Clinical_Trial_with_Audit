    ...
    public class AdminController : Controller
    {
        ...
        public ActionResult Approve(int id)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //CTC.ObjectStateManager.ChangeObjectState(tbl_Register_user, EntityState.Modified);
                CTC.Entry(tbl_Register_user).State = EntityState.Modified;
                CTC.SaveChanges(tbl_Register_user.Reg_No);
                //CTC.SaveAudit(tbl_Register_user.Reg_No);
